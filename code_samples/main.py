...
while True:
    ...
    print("Credits: Mobassar@4u (My Github is: https://github.com/Mobassar4u)" if logged_in != "true" else "")
    print("====================================")
    ...
    if ch == 1:
        ...
        if logged_in == "true":
            ...
            print("The generated m3u will be saved as TataPlayPlaylist.m3u under the code_samples directory")
            print("************************************")
            utils.m3ugen()
        else:
